<div class="row mb-4">
    ...
    <div class="col-sm-10">
        <input name="title" type="text" id="title" placeholder="ادخل عنوان لسياسة الخصوصيه"
...
<div class="row mb-4">
    ...
    <div class="col-sm-10">
        <textarea name="description" id="summernote" class="col-sm-12 form-control @error('description') is-invalid @enderror"
            placeholder="ادخل وصف لسياسة الخصوصيه">{{ old('description', $policy->description) }}</textarea>
        @error('description')
            <p class="invalid-feedback">{{ $message }}</p>
        @enderror
    </div>
