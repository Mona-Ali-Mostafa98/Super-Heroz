        ...
        <div class="row pagetitle mb-2">
            <div class="col-sm-6 d-flex justify-content-start">
                <h1 class="mb-2 fs-2">الخدمات
                    <a href="{{ route('admin.services.create') }}" class="ms-3 btn btn-outline-primary mb-2 ">
                        <i class="bi bi-plus-lg"></i> أنشاء خدمه </a>
                </h1>
            </div>
        </div>
        <!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fs-4 mb-3"> الخدمات </h5>
                                ...
                                <tbody>
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td class="text-primary fw-bold">{{ $service->title }}</td>
                                            <td>{{ $service->status }}</td>
                                            <td>{{ $service->created_at->translatedFormat('l , j F Y') }}
                                            </td>
                                            <td>
